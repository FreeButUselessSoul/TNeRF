...
class NeRF(nn.Module):
    def __init__(self, typ,
                 ...
                 encode_transient=False, in_channels_t=16, in_channels_f=512, in_channels_fr=256,
                 beta_min=0.03):
        """
        ...
        self.in_channels_fr = in_channels_fr
        ...
        if self.encode_transient:
            ...
            #                             nn.Linear(W//2, W//2), nn.ReLU(True))
            self.transient_encoding = nn.Sequential(
                                        nn.Linear(W+in_channels_t+self.in_channels_fr, W+self.in_channels_fr//2), nn.ELU(inplace=True),
                                        nn.Linear(W+self.in_channels_fr//2, W), nn.ELU(inplace=True),
