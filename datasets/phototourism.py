...
class PhototourismDataset(Dataset):
    def __init__(self, root_dir, split='train', img_downscale=1, val_num=1,
        ...
        if 'test_appearance_idx' in kwargs:
            self.test_appearance_idx = kwargs['test_appearance_idx']
        if self.split == 'train':
    ...
    def read_meta(self):
        ...
        if self.split == 'train': # create buffer of all rays and rgb data
            ...
            if self.test_image:
                ...
                self.w_reflection = add_reflection(image, 'llff_im', self.test_appearance_idx)
