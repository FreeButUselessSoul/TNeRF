...
def get_opts():
    ...
    parser.add_argument('--use_patch', default=False, action="store_true",
                        help='whether to use patch')
    parser.add_argument('--use_D', nargs="+", type=str, default=[],
                        help='What discriminators to use')
...
#                         help='number of gpus')
    parser.add_argument('--gpus', type=str, default='0',
                        help='specify the gpus, use comma to separate different gpus')
    ...
    parser.add_argument('--latent_dim', type=int, default=32,
                        help='Latent dim of encoder')
    parser.add_argument('--sample_wh', type=int, default=64,
    ...
    ###########################
    ####  params for loss  ####
    parser.add_argument('--bdc', default=False, action="store_true",
                        help='whether to use BDC loss')
